...
module bug_pub::moderator {
    use sui::tx_context::{sender};

    /// Represents a moderator that can be used to delete audits
    ...
    public fun add_moderator(
        ...
        // generate an NFT and transfer it to moderator who may use it to delete audits
        let mod = Moderator {
            id: object::new(ctx)
        };
