...
MOVE_PACKAGE_PATH=../move/bug_pub
...
publish_res=$(sui client publish --skip-fetch-latest-git-deps --gas-budget 200000000 --json ${MOVE_PACKAGE_PATH})
...
# sui client call --gas-budget 4000000 --package "$PACKAGE_ID" --module "dashboard" --function "create_dashboard" --args "test"

echo sui client call --gas-budget 4000000 --package "$PACKAGE_ID" --module "dashboard" --function "create_dashboard" --args "test"
